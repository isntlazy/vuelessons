<template>
  <footer class="py-16 px-32 bg-primary sm:py-16 mt-20">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="/" class="hover:underline">Rankova Kava ☕️</a>. Усі права збережено.
      </span>
      <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
        <a v-if="false" href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
